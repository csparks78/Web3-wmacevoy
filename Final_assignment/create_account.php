      ...
      <div id="wb_Signup1" style="position:absolute;left:329px;top:219px;width:313px;height:478px;z-index:2;">
         <form name="signupform" method="post" accept-charset="UTF-8" action="<?php echo basename(__FILE__); ?>" id="signupform">
            ...
            <table id="Signup1">
               ...
               <tr>
                  <td style="text-align:center;vertical-align:bottom"><input type="submit" id="Button1" onclick="window.location.href='./login.php';return false;" name="" value="Cancel" style="position:absolute;left:437px;top:711px;width:96px;height:25px;z-index:3;">
               </tr>
            </table>
         </form>
      </div>
